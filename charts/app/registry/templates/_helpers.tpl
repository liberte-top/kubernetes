...
{{- define "app-registry.componentName" -}}
{{- printf "%s-%s" (include "app-registry.fullname" .root) .component -}}
{{- end -}}

{{- define "app-registry.labels" -}}
app.kubernetes.io/name: {{ include "app-registry.fullname" .root }}
...
spec:
  ...
  template:
    metadata:
      labels:
        app: {{ include "app-registry.componentName" (dict "root" $root "component" $name) }}
{{ include "app-registry.labels" (dict "root" $root "component" $name) | indent 8 }}
...
{{- define "app-registry.ingressAnnotations" -}}
{{- range $key, $value := .Values.ingress.annotations }}
{{ $key }}: {{ $value | quote }}
{{- end }}
{{- end -}}

{{- define "app-registry.ingressTls" -}}
